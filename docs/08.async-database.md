...
Download [`ecewo-postgres.c`](https://github.com/savashn/ecewo-modules/blob/main/postgres/ecewo-postgres.c) and [`ecewo-postgres.h`](https://github.com/savashn/ecewo-modules/blob/main/postgres/ecewo-postgres.h) files and add them into your CMake configuration.
