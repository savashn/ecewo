...
Download [`ecewo-fs.c`](https://github.com/savashn/ecewo-packages/blob/main/fs/ecewo-fs.c) and [`ecewo-fs.h`](https://github.com/savashn/ecewo-packages/blob/main/fs/ecewo-fs.h) files and add them into your CMake configuration.
