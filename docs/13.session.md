...
Add `ecewo/session.h` module before `MakeAvailable`:
...
Alternatively, you can download [`ecewo-session.c`](https://github.com/savashn/ecewo-modules/blob/main/session/ecewo-session.c) and [`ecewo-session.h`](https://github.com/savashn/ecewo-modules/blob/main/session/ecewo-session.h) files and add them into your CMake configuration.
