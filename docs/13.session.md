...
Download [`ecewo-session.c`](https://github.com/savashn/ecewo-packages/blob/main/session/ecewo-session.c) and [`ecewo-session.h`](https://github.com/savashn/ecewo-packages/blob/main/session/ecewo-session.h) files and add them into your CMake configuration.

> [!NOTE]
>
> Session package uses the [Cookie](/docs/13.cookie.md) under the hood. That means, you also need to download [`ecewo-cookie.c`](https://github.com/savashn/ecewo-packages/blob/main/cookie/ecewo-cookie.c) and [`ecewo-cookie.h`](https://github.com/savashn/ecewo-packages/blob/main/cookie/ecewo-cookie.h) files.
