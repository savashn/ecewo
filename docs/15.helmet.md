...
Download [`ecewo-helmet.c`](https://github.com/savashn/ecewo-packages/blob/main/helmet/ecewo-helmet.c) and [`ecewo-helmet.h`](https://github.com/savashn/ecewo-packages/blob/main/helmet/ecewo-helmet.h) files and add them into your CMake configuration.
